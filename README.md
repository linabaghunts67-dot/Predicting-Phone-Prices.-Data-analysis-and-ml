...
Handled missing and null values using appropriate imputation techniques

Performed exploratory data analysis (EDA) to understand relationships between features and price

Applied multiple machine learning models for price prediction

Compared models based on accuracy, precision, recall, F1 score, and R² score
